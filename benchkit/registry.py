...
AFQMC_LANE = LaneSpec(
    ...
    objective_metric="tail_mean_plus_2stderr",
    objective_text="Lower the 5-minute molecular AFQMC risk-adjusted score tail_mean + 2*stderr, where tail_mean and stderr are computed from the last 40% of sampled blocks, without changing the molecular geometry or basis. CCSD(T) error remains an offline comparison metric.",
