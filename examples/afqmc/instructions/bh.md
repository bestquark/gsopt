Work only on the `BH` AFQMC benchmark.
...
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/bh/initial_script.py --molecule BH --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/bh/initial_script.py --molecule BH`
