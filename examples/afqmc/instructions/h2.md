Work only on the `H2` AFQMC benchmark.
...
Edit only:
- `h2/initial_script.py`

Fixed evaluation command:
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/h2/initial_script.py --molecule H2 --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/h2/initial_script.py --molecule H2`
