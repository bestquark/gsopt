Work only on the `HF` AFQMC benchmark.
...
Edit only:
- `hf/initial_script.py`

Fixed evaluation command:
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/hf/initial_script.py --molecule HF --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/hf/initial_script.py --molecule HF`
