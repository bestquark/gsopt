Work only on the `LiH` AFQMC benchmark.
...
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/lih/initial_script.py --molecule LiH --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/afqmc/lih/initial_script.py --molecule LiH`
