# Parallel DMRG Sessions

Start Codex from `/Users/lmantilla/Desktop/Internship/autoresearch/examples/dmrg`.
Keep the session in that `dmrg/` directory.

Open five Codex windows in the same repo tree and use one file per window:
- `heisenberg_xxx_384.md`
- `xxz_gapless_256.md`
- `tfim_longitudinal_256.md`
- `spin1_heisenberg_64.md`
- `spin1_single_ion_critical_64.md`
...
If the target `simple_dmrg.py` file is missing or clearly corrupted, stop and
...
machine and wall-clock budget, and each scored DMRG run caps BLAS/OpenMP thread
counts at 10.
