Work only on the `heisenberg_2d_4x4` TN benchmark.
...
Edit only:
- `heisenberg_2d_4x4/initial_script.py`

Fixed evaluation command:
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/heisenberg_2d_4x4/initial_script.py --model heisenberg_2d_4x4 --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/heisenberg_2d_4x4/initial_script.py --model heisenberg_2d_4x4`
...
10. Do not change the model Hamiltonian or lattice size.
