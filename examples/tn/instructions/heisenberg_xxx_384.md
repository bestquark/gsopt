Work only on the `heisenberg_xxx_384` TN benchmark.
...
Edit only:
- `heisenberg_xxx_384/initial_script.py`

Fixed evaluation command:
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/heisenberg_xxx_384/initial_script.py --model heisenberg_xxx_384 --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/heisenberg_xxx_384/initial_script.py --model heisenberg_xxx_384`
...
11. Keep the method family bounded to the intended tensor-network search space in the file. Do not import unrelated solver stacks.
