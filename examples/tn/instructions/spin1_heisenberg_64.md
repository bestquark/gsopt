Work only on the `spin1_heisenberg_64` TN benchmark.
...
Edit only:
- `spin1_heisenberg_64/initial_script.py`

Fixed evaluation command:
`uv run python queued_track_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/spin1_heisenberg_64/initial_script.py --model spin1_heisenberg_64 --wall-seconds 20 --max-parallel 1 --description "<one-line mutation summary>"`

Restore-best command:
`uv run python restore_best_iteration.py --script /Users/lmantilla/Desktop/Internship/autoresearch/examples/tn/spin1_heisenberg_64/initial_script.py --model spin1_heisenberg_64`
